...
public class TesteLampada {
    public static void main(String[] args){
        ...
        lampada1.acender();
        System.out.println("Lâmpada 1 após acender: ");
        if(lampada1.estaLigada()) System.out.println("A lâmpada 1 está ligada!");
        else System.out.println("A lâmpada 1 está desligada!");

        lampada2.apagar();
        System.out.println("Lâmpada 2 após apagar: ");
        if(lampada2.estaLigada()) System.out.println("A lâmpada está 2 está ligada!");
        else System.out.println("A lâmpada 2 está desligada!");
